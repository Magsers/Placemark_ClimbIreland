...
export const webRoutes = [
  ...
  { method: "GET", path: "/dashboard/editcrag/{id}", config: dashboardController.showEditCrag },
  { method: "POST", path: "/dashboard/updatecrag/{id}", config: dashboardController.updateCrag },
